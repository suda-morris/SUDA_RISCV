...
HOST_WORK_FOLDER_PATH="${HOME}/Work/${APP_LC_NAME}-${RELEASE_VERSION}"
CONTAINER_WORK_FOLDER_PATH="${HOME}/Work/${APP_LC_NAME}-${RELEASE_VERSION}"
...
mkdir -p "${HOST_WORK_FOLDER_PATH}"/build.git/scripts
mkdir -p "${HOST_WORK_FOLDER_PATH}"/build.git/patches
mkdir -p "${HOST_WORK_FOLDER_PATH}"/build.git/pkgconfig
cp -r "$(dirname ${script_folder_path})"/* "${HOST_WORK_FOLDER_PATH}"/build.git/scripts
cp -r "${HOME}/Downloads/openocd-build.git/patches"/* "${HOST_WORK_FOLDER_PATH}"/build.git/patches
cp -r "${HOME}/Downloads/openocd-build.git/pkgconfig"/* "${HOST_WORK_FOLDER_PATH}"/build.git/pkgconfig
